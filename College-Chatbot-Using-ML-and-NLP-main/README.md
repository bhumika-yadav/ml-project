...
You can run the [Chatbot.ipynb](https://github.com/bhumika-yadav/ml-project/blob/master/College-Chatbot-Using-ML-and-NLP-main/College%20Chatbot.ipynb) which also includes step by step instructions in [Jupyter Notebook](https://www.geeksforgeeks.org/how-to-install-jupyter-notebook-in-windows/).
